...
_Formatting output **in PQL** ([View query results](https://nextapi.getpop.org/api/graphql/?query=posts.id|title|dateAsString(format:d/m/Y))):_
...
_**In PQL** ([View query results](https://nextapi.getpop.org/api/graphql/?query=posts.id|title|dateAsString(d/m/Y))):_
...
_**In PQL** ([View query results](https://nextapi.getpop.org/api/graphql/?query=posts.id|title|dateAsString(d/m/Y)@formattedDate)):_
...
_**In PQL** ([View query results](https://nextapi.getpop.org/api/graphql/?query=posts.id|title|date|dateAsString(d/m/Y))):_
...
_**In PQL** (View results: [query 1](https://nextapi.getpop.org/api/graphql/?query=posts.id|title|dateAsString($format)&format=d/m/Y), [query 2](https://nextapi.getpop.org/api/graphql/?query=posts.id|title|dateAsString($format)&variables[format]=d/m/Y)):_
